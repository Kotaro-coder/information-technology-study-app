...
import { CREATE_PLAN } from "../mutations/planMutations";
import { Plan } from "../app/types/plan";
import { GET_PLANS } from "../query/planQueries";
import { useRouter } from "next/navigation";

export default function AddPlan({ userId }: { userId: number | null }) {
  ...
  const [createPlan] = useMutation<{ createPlan: Plan }>(CREATE_PLAN);
